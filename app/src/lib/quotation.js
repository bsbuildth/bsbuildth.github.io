...
export function newQuote() {
  ...
  return { schemaVersion: 7, number: '', date, customer: '', phone: '', project: '', seller: 'BSBuildTh', sellerPhone: '', sellerAddress: '', sellerTaxId: '', sellerWebsite: '', salesperson: '', bankName: '', bankAccountName: '', bankAccountNumber: '', sellerSignatureImage: '', showLogo: true, discountType: 'amount', billDiscount: '0.00', vatRate: '7',
