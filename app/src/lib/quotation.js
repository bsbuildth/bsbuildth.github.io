...
export function newQuote() {
  ...
  return { schemaVersion: 8, number: '', date, customer: '', phone: '', project: '', seller: 'BSBuildTh', sellerPhone: '', sellerAddress: '', sellerTaxId: '', sellerWebsite: '', salesperson: '', bankName: '', bankAccountName: '', bankAccountNumber: '', customerSignatureImage: '', customerSignerName: '', customerSignedAt: '', sellerSignatureImage: '', sellerSignerName: '', sellerSignedAt: '', showLogo: true, discountType: 'amount', billDiscount: '0.00', vatRate: '7',
