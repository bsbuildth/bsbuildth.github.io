...
export default function Quotations() {
  ...
  const dockActions = [
    { id: 'workspace', icon: '⌂', label: 'หน้าทำงาน', onClick: () => navigate('/admin') },
    { id: 'save', icon: '✓', label: 'คำนวณและบันทึก', onClick: save, disabled: locked || !dirty || !!calculation.error },
    { id: 'preview', icon: '◫', label: previewMode ? '← กลับมาแก้ไข' : 'ดูตัวอย่าง', onClick: () => setPreviewMode(current => !current), disabled: !!calculation.error },
