...
export default function Receipts() {
  ...
  return <><AdminRouteDock activePath="/admin/receipts" /><div className="quotation-workspace receipt-workspace">
    ...
    <p className="quote-message" role="status" aria-live="polite">{selected?.status === 'issued' ? '🔒 ใบเสร็จนี้ออกเอกสารแล้ว จึงล็อกข้อมูลและยอดเงินเพื่อป้องกันความผิดพลาด ใช้ “ทำใบเสร็จใหม่จากฉบับนี้” หากต้องการรายการใหม่' : (message || 'กรอกและบันทึกครั้งเดียว แล้วพิมพ์ต้นฉบับกับสำเนาได้ทันที')}</p>
